...
const FeatureCard = ({ icon: Icon, title, sub, description, delay, highlight }: { icon: any, title: string, sub: string, description: string, delay: number, highlight?: string }) => (
  <motion.div 
    ...
    className="bg-white p-8 rounded-[2rem] shadow-[0_10px_40px_-10px_rgba(100,116,139,0.08)] hover:shadow-[0_20px_60px_-15px_rgba(139,92,246,0.15)] transition-all duration-500 hover:-translate-y-2 border border-slate-100 group relative overflow-hidden h-full"
  >
    <div className="absolute top-0 right-0 p-8 opacity-[0.05] group-hover:opacity-[0.1] transition-opacity duration-500 transform group-hover:scale-110 group-hover:rotate-12 origin-top-right">
        <Icon size={140} className="text-violet-500" />
    </div>
    <div className="relative z-10">
        <div className="h-14 w-14 lg:h-16 lg:h-16 bg-gradient-to-br from-slate-50 to-white rounded-2xl flex items-center justify-center mb-6 lg:mb-8 shadow-inner group-hover:from-violet-50 group-hover:to-fuchsia-50 transition-all border border-slate-100">
        ...
        <h3 className="text-xl lg:text-2xl font-bold text-slate-800 mb-3 lg:mb-4 tracking-tight group-hover:text-transparent bg-clip-text group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-fuchsia-600 transition-all duration-300">{title}</h3>
        <p className="text-slate-600 leading-relaxed break-keep text-sm lg:text-[15px] font-medium">{description}</p>
    </div>
  </motion.div>
);
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 text-slate-900 overflow-x-hidden font-sans selection:bg-fuchsia-200 selection:text-fuchsia-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full pt-28 pb-12 lg:pt-32 lg:pb-20">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-[2.75rem] sm:text-5xl lg:text-[5.5rem] font-black text-white leading-[1.1] lg:leading-[1.05] mb-6 lg:mb-8 tracking-tight break-keep drop-shadow-xl">
              ...
              <p className="text-base lg:text-xl text-slate-200 mb-10 lg:mb-14 max-w-xl leading-relaxed font-normal pl-4 lg:pl-6 border-l-4 border-teal-500/50 drop-shadow-md">
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-28 lg:top-40 -right-4 lg:-right-8 bg-white/80 backdrop-blur-xl p-4 lg:p-5 rounded-[2rem] shadow-[0_20px_40px_rgba(0,0,0,0.05)] flex items-center gap-3 lg:gap-4 z-30 border border-white/80 ring-1 ring-white/50 scale-90 lg:scale-100"
              >
              ...
              <motion.div 
                ...
                className="absolute bottom-28 lg:bottom-40 -left-6 lg:-left-12 bg-white/80 backdrop-blur-xl p-4 lg:p-5 rounded-[2rem] shadow-[0_20px_40px_rgba(0,0,0,0.05)] flex items-center gap-3 lg:gap-4 z-30 border border-white/80 ring-1 ring-white/50 scale-90 lg:scale-100"
              >
      ...
      <section className="py-20 lg:py-32 bg-white relative" id="market">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            ...
            <h2 className="text-3xl lg:text-5xl font-black mt-6 mb-6 lg:mb-8 text-slate-900 leading-tight">
              '보상'이 곧 '마케팅'이 되는<br/>
            ...
            <p className="text-slate-600 text-base lg:text-lg break-keep font-medium leading-loose">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-16">
            <div className="p-8 lg:p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:border-violet-200 transition-all shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(139,92,246,0.15)] hover:-translate-y-2 group duration-500">
              <div className="flex items-center justify-between mb-6 lg:mb-8">
                 <div className="p-3 lg:p-4 bg-violet-50 rounded-2xl shadow-sm group-hover:scale-110 transition-transform group-hover:bg-violet-100"><Users className="text-violet-600 w-6 h-6"/></div>
              ...
              <div className="text-4xl lg:text-5xl font-black text-slate-900 mb-4 tracking-tight">1,022<span className="text-2xl text-slate-400 font-medium ml-1">만</span></div>
            ...
            <div className="p-8 lg:p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:border-fuchsia-200 transition-all shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(232,121,249,0.15)] hover:-translate-y-2 group duration-500">
              <div className="flex items-center justify-between mb-6 lg:mb-8">
                 <div className="p-3 lg:p-4 bg-fuchsia-50 rounded-2xl shadow-sm group-hover:scale-110 transition-transform group-hover:bg-fuchsia-100"><TrendingUp className="text-fuchsia-600 w-6 h-6"/></div>
              ...
              <div className="text-4xl lg:text-5xl font-black text-slate-900 mb-4 tracking-tight">21.5<span className="text-2xl text-slate-400 font-medium ml-1">%</span></div>
               <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden my-5">
            ...
            <div className="p-8 lg:p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:border-amber-200 transition-all shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(251,191,36,0.15)] hover:-translate-y-2 group duration-500">
              <div className="flex items-center justify-between mb-6 lg:mb-8">
                 <div className="p-3 lg:p-4 bg-amber-50 rounded-2xl shadow-sm group-hover:scale-110 transition-transform group-hover:bg-amber-100"><PieChart className="text-amber-600 w-6 h-6"/></div>
              ...
              <div className="text-4xl lg:text-5xl font-black text-slate-900 mb-4 tracking-tight">9.2<span className="text-2xl text-slate-400 font-medium ml-1">조</span></div>
               <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden my-5">
          ...
          <div className="bg-slate-50 rounded-[3rem] p-6 lg:p-12 border border-slate-100 shadow-[inset_0_2px_20px_rgba(0,0,0,0.02)]">
            <h3 className="text-xl font-bold text-slate-900 mb-8 ml-4">Market Size Forecast</h3>
            <div className="h-[300px] lg:h-[400px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={marketData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                  <defs>
                  ...
                  <XAxis dataKey="year" axisLine={false} tickLine={false} tick={{fill: '#475569', fontSize: 12, fontWeight: 600}} dy={10} />
                  <YAxis axisLine={false} tickLine={false} tick={{fill: '#475569', fontSize: 12, fontWeight: 600}} dx={-10} />
                  <Tooltip 
                    contentStyle={{ backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #f1f5f9', boxShadow: '0 10px 25px rgba(0,0,0,0.05)' }}
                    itemStyle={{ color: '#1e293b', fontWeight: 'bold' }}
                    cursor={{ stroke: '#cbd5e1', strokeWidth: 1, strokeDasharray: '4 4' }}
                  />
                  <Area type="monotone" dataKey="size" stroke="#8b5cf6" strokeWidth={4} fillOpacity={1} fill="url(#colorSize)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
